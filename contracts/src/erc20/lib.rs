...
mod erc20 {
    ...
    impl Erc20 {
        ...
        /// Creates a new ERC-20 contract with the specified initial supply adn recipient.
        #[ink(constructor)]
        pub fn new_with_recipient(total_supply: U256, recipient: Address) -> Self {
            let mut balances = Mapping::default();
    ...
    mod tests {
        ...
        fn assert_transfer_event(
            ...
            expected_topics
                .push(ink::blake2x256!("Transfer(Option<Address>,Option<Address>,U256)").into());
        ...
        fn balance_of_works() {
            ...
            // Transfer event triggered during initial construction
            let emitted_events = ink::env::test::recorded_events().collect::<Vec<_>>();
            assert_transfer_event(&emitted_events[0], None, Some(accounts.alice), 100.into());
            let accounts = ink::env::test::default_accounts();
    ...
    mod e2e_tests {
        ...
        async fn e2e_allowances<Client: E2EBackend>(mut client: Client) -> E2EResult<()> {
            ...
            let transfer_from = call_builder.transfer_from(bob_account, charlie_account, 1.into());
            let transfer_from_result = client
                .call(&ink_e2e::charlie(), &transfer_from)
                .submit()
                .await;
